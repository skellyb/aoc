...
fn main() {
    ...
    let input = include_str!("../res/day-14.txt");
    let (d14p1, d14p2) = day_14::run(input);
    println!("Day 14: {} {}", d14p1, d14p2);

    // ...

    let input = include_str!("../res/day-18.txt");
    let (d18p1, d18p2) = day_18::run(input);
    println!("Day 18: {} {}", d18p1, d18p2);
}
