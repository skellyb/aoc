...
17
32"
  assert day05.run_pt1(input) == 3
}

pub fn day5_pt2_test() {
  let input =
    "3-5
10-14
12-18
...
17
32"
  assert day05.run_pt2(input) == 14
}

pub fn day6_pt1_test() {
  let input =
    "123 328  51 64
  45 64  387 23
  6 98  215 314
*   +   *   +  "
  assert day06.run_pt1(input) == 4_277_556
}

pub fn day6_pt2_test() {
  let input =
    [
      "123 328  51 64 ",
      " 45 64  387 23 ",
    ...
    |> string.join("\n")
  assert day06.run_pt2(input) == 3_263_827
}

pub fn day7_pt1_test() {
  let input =
    ".......S.......
...............
.......^.......
...
.^.^.^.^.^...^.
..............."
  assert day07.run_pt1(input) == 21
}

pub fn day7_pt2_test() {
  let input =
    ".......S.......
...............
.......^.......
